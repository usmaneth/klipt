...
>(({ className, ...props }, ref) => (
	<SliderPrimitive.Root
		...
		{...props}
	>
		<SliderPrimitive.Track className="relative h-1.5 w-full grow overflow-hidden rounded-full bg-secondary bg-white/10">
			<SliderPrimitive.Range className="absolute h-full bg-primary bg-[#2563EB]" />
