            ...
            {showSuccess ? (
              <>
                ...
                <div className="flex flex-col gap-1.5">
                  <span className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-400 drop-shadow-[0_0_8px_rgba(255,255,255,0.3)] block">{t('export.exportComplete')}</span>
                  <span className="text-sm text-cyan-300/80 font-medium">{t('export.formatReady', undefined, { format: formatLabel.toLowerCase() })}</span>
                  {exportedFilePath && (
                    <Button
                      variant="secondary"
        ...
        {isExporting && progress && (
          <div className="space-y-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-white/5 rounded-2xl p-4 border border-white/10 shadow-[inset_0_1px_0_rgba(255,255,255,0.05)]">
                <div className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-1.5">{t('export.frames')}</div>
