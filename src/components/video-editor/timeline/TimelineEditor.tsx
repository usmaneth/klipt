    ...
    return (
      <div className="flex-1 flex flex-col items-center justify-center rounded-lg bg-transparent gap-4">
        ...
        <div className="text-center">
          <p className="text-base font-semibold text-slate-200 tracking-wide drop-shadow-[0_0_5px_rgba(255,255,255,0.2)]">No Video Loaded</p>
          <p className="text-sm font-medium text-slate-500 mt-1">Drag and drop a video to start editing</p>
        </div>
      </div>
    );
  }
      ...
      <div className="flex items-center gap-2 px-5 py-3 border-b border-white/10 bg-[#0A0D15]/80 backdrop-blur-xl shadow-[0_2px_15px_rgba(0,0,0,0.3)] relative z-10">
        ...
        <div className="flex items-center gap-2">
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              ...
              >
                <span className="font-medium tracking-wide">{getAspectRatioLabel(aspectRatio)}</span>
                <ChevronDown className="w-3.5 h-3.5 opacity-70" />
              </Button>
            </DropdownMenuTrigger>
            <DropdownMenuContent align="end" className="bg-[#11131A]/95 backdrop-blur-2xl border-white/10 shadow-[0_10px_30px_rgba(0,0,0,0.8)] rounded-xl overflow-hidden p-1">
              {ASPECT_RATIOS.map((ratio) => (
                ...
                >
                  ...
                  {aspectRatio === ratio && <Check className="w-4 h-4 text-cyan-400 drop-shadow-[0_0_5px_rgba(34,211,238,0.5)]" />}
                </DropdownMenuItem>
              ))}
              ...
              <div className="px-3 py-2.5 flex items-center gap-2.5 text-slate-300 bg-white/[0.02] rounded-lg">
                ...
                {isCustomAspectRatio(aspectRatio) && <Check className="w-4 h-4 text-cyan-400 drop-shadow-[0_0_5px_rgba(34,211,238,0.5)] ml-auto" />}
              </div>
            </DropdownMenuContent>
          </DropdownMenu>
        ...
        <div className="flex items-center gap-4 text-[10px] text-slate-400 font-semibold tracking-wide uppercase">
          <span className="flex items-center gap-2 drop-shadow-[0_0_2px_rgba(0,0,0,0.5)]">
            <kbd className="px-2 py-0.5 bg-white/5 border border-white/10 rounded-md text-blue-400 font-sans shadow-sm">Side Scroll</kbd>
            <span>Pan</span>
          </span>
          <span className="flex items-center gap-2 drop-shadow-[0_0_2px_rgba(0,0,0,0.5)]">
            <kbd className="px-2 py-0.5 bg-white/5 border border-white/10 rounded-md text-blue-400 font-sans shadow-sm">{scrollLabels.pan}</kbd>
            <span>Pan</span>
          </span>
          <span className="flex items-center gap-2 drop-shadow-[0_0_2px_rgba(0,0,0,0.5)]">
            <kbd className="px-2 py-0.5 bg-white/5 border border-white/10 rounded-md text-blue-400 font-sans shadow-sm">{scrollLabels.zoom}</kbd>
            <span>Zoom</span>
          </span>
        </div>
      </div>
