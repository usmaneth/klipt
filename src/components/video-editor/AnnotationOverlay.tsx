...
export function AnnotationOverlay({
	...
	const renderArrow = () => {
		...
		const color = annotation.figureData?.color || "#E0000F";
	...
	return (
		<Rnd
			...
			className={cn(
				...
				isSelected && "ring-2 ring-[#E0000F] ring-offset-2 ring-offset-transparent",
			)}
			style={{
				zIndex: isSelectedBoost ? zIndex + 1000 : zIndex, // Boost selected annotation to ensure it's on top
				pointerEvents: isSelected ? "auto" : "none",
				border: isSelected ? "2px solid rgba(224, 0, 15, 0.8)" : "none",
				backgroundColor: isSelected ? "rgba(224, 0, 15, 0.1)" : "transparent",
				boxShadow: isSelected ? "0 0 0 1px rgba(224, 0, 15, 0.35)" : "none",
			}}
			...
			resizeHandleStyles={{
				topLeft: {
					...
					border: isSelected ? "2px solid #E0000F" : "none",
					borderRadius: "50%",
					left: "-6px",
					top: "-6px",
					cursor: "nwse-resize",
