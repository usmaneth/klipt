			...
			<DialogContent className="bg-[#09090b] border-white/10 text-white max-w-[420px]">
				<DialogHeader>
					<DialogTitle className="flex items-center gap-2 text-sm">
						<Keyboard className="w-4 h-4 text-[#E0000F]" />
								...
								<div className="flex items-center justify-between py-1.5 px-1 border-b border-white/5">
									...
									<button
										...
										className={[
											...
											isCapturing
												? "bg-[#E0000F]/20 border-[#E0000F] text-[#E0000F] animate-pulse"
												: hasConflict
													? "bg-amber-500/10 border-amber-500/50 text-amber-400"
													: "bg-white/5 border-white/10 text-slate-200 hover:border-[#E0000F]/50 hover:text-[#E0000F] cursor-pointer",
										].join(" ")}
									>
										{isCapturing
									...
									<div className="flex items-center justify-between px-1 py-1.5 mb-0.5 bg-amber-500/10 border border-amber-500/20 rounded text-xs">
										<span className="text-amber-400">
											{t("shortcutsConfig.alreadyUsedBy", undefined, {
												action: SHORTCUT_LABELS[conflict.conflictWith.action],
											})}
										</span>
				...
				<p className="text-[10px] text-slate-500 mt-1">{t("shortcutsConfig.instructions")}</p>
