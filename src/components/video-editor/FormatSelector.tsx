				...
				return (
					<button
						...
						className={cn(
							...
							"focus:outline-none focus:ring-2 focus:ring-[#E0000F]/50 focus:ring-offset-2 focus:ring-offset-[#09090b]",
							isSelected
								? "bg-[#E0000F]/10 border-[#E0000F]/50 text-white"
					...
					>
						<div
							className={cn(
								...
								isSelected ? "bg-[#E0000F]/20 text-[#E0000F]" : "bg-white/5",
							)}
						>
							{option.icon}
						</div>
						...
						{isSelected && (
							<div className="absolute top-2 right-2 w-2 h-2 rounded-full bg-[#E0000F]" />
						)}
					</button>
				);
			})}
